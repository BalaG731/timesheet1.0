...
setTimeout(function() {    
    ...
    $("#header").append("\
        <div style='right: 0; background: #f4f4f4; color: #333; padding: 10px;font-size: 1em; box-shadow:#d2d2d2 0px 3px 1px; line-height:30px;'>\
            <div style='margin-bottom:5px; padding-left: 5px; display: inline; margin-left:3px;" + presentedSortHoursStyles + "'>\
                Total number of days present:" + presentDays + ".\
            </div> \
            <div style='margin-bottom:5px; padding-left: 5px; display: inline;'>\
                Expected hours for this month : " + requiredHours + " hrs.\
            </div> \
            <div style='margin-bottom:5px; padding-left: 5px; display: inline;'>\
                Swiped hours for this month* : " + totalHours + " hrs\
            </div> \
            <div style ='display: inline;padding-left: 15px;" + style + "'> \
                " + hoursLabel + sortedHours + " hrs \
            </div> \
            <div style='margin-bottom:5px; padding-left: 15px; display: inline;" + requiredHoursStyles + "'>\
                Expected hours for today*  : " + neededHours + " hrs to match.\
            </div>\             
            <div>\
                Deviation until today* : "+ presentedSortHours +" hours "+ presentedSortHoursText + " \
            </div>\
            <div style='margin:12px 0 0 0; padding-left: 5px;display: inline;'>\
            Expected swipe hours from tomorrow: " + laggHours + "hrs only.\
            </div>\
        </div>")    
}, 500);